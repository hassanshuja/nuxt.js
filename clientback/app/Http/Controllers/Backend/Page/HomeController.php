...
class HomeController extends Controller{
    ...
    {
        $page = PageBuilder::where('slug','home')->first();
        if(!empty($page)){
            if ($page['section_1']){
        ...
        return view('backend.page.home.index', ['page_title' => 'Men Page Management','page'=>$page]);
    }
    ...
    public function storeSection1(){
        ...
        if(isset($data['section_1']['image_url']) && !empty($data['section_1']['image_url'])) {
            ...
            //Upload File
            $image_url = $file->storePubliclyAs('images/page/home', $filenametostore);
        ...
        PageBuilder::updateOrCreate(['slug'=>'home'],['section_1'=>json_encode($data['section_1'])]);
    }
    ...
    public function storeSection2(){
        ...
        PageBuilder::updateOrCreate(['slug'=>'home'],['section_2'=>json_encode($data['section_2'])]);
    }
    ...
    public function storeSection3(){
        ...
        PageBuilder::updateOrCreate(['slug'=>'home'],['section_3'=>json_encode($data['section_3'])]);
    }
}