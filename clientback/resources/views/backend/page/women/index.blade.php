...
@include('backend.page.women.css')
@section('content')
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.women.store-section1') !!}">
            ...
            <div class="col-lg-6">
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" onsubmit="return false" id="section_2_form" action="{!! route('admin.page.women.store-section2') !!}">
                        <div class="kt-portlet__body">
                            <div class="kt-form__section kt-form__section--first">
                                <div class="row">
                                    <div class="col-md-6">
            ...
            <div class="col-lg-6">
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" onsubmit="return false" id="section_3_form" action="{!! route('admin.page.women.store-section3') !!}">
                        <div class="kt-portlet__body">
                            <div class="kt-form__section kt-form__section--first">
                                <div class="row">
                                    <div class="col-md-6">
