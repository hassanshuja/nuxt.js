...
@include('backend.page.contact.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.contact.add') !!}">
...
@endsection
@include('backend.page.contact.js')
