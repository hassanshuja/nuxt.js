...
@include('backend.page.partnership.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.partnership.add') !!}">
...
@endsection
@include('backend.page.partnership.js')
