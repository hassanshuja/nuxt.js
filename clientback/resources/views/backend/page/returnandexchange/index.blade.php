...
@include('backend.page.returnandexchange.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.returnandexchange.add') !!}">
...
@endsection
@include('backend.page.returnandexchange.js')
