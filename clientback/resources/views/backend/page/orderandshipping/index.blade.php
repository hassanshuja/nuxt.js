...
@include('backend.page.orderandshipping.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.orderandshipping.add') !!}">
...
@endsection
@include('backend.page.orderandshipping.js')
