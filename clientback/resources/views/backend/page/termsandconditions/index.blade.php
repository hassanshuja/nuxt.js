...
@include('backend.page.termsandconditions.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.termsandconditions.add') !!}">
...
@endsection
@include('backend.page.termsandconditions.js')
