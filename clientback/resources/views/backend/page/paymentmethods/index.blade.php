...
@include('backend.page.paymentmethods.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.paymentmethods.add') !!}">
...
@endsection
@include('backend.page.paymentmethods.js')
