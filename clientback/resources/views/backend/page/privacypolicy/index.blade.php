...
@include('backend.page.privacypolicy.css')
@section('content')
    <div class="kt-portlet">
        ...
        <form class="kt-form" onsubmit="return false" id="section_1_form" action="{!! route('admin.page.privacypolicy.add') !!}">
...
@endsection
@include('backend.page.privacypolicy.js')
