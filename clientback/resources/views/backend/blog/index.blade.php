...
@include('backend.blog.css')
@section('content')
    @include('backend.blog.add')
    @include('backend.blog.view-images')
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="javascript:void(0)" data-type="add" data-action="{!! route('admin.blog.add') !!}" data-toggle="modal" data-target="#add" class="btn btn-success btn-icon-sm">
