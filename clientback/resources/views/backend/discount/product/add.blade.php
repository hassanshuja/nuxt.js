<div class="modal fade modal-data" id="add-product-discount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group kt-form__group">
                                ...
                                <input type="text" name="title" autocomplete="off" id="product_title" class="form-control" placeholder="Title">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group kt-form__group">
                                <label for="code" class="form-control-label">Title (Indo):</label>
                                <input type="text" name="title_l" autocomplete="off" id="product_title_l" class="form-control" placeholder="Title">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-daterange input-group m_datepicker" >
                                        <input type="text" class="form-control" placeholder="Start Date" id="product_start_at" name="start_at" readonly />
                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-ellipsis-h"></i>
                                                            </span>
                                        </div>
                                        <input type="text" class="form-control" placeholder="End Date" id="product_end_at" name="end_at" readonly />
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div data-repeater-item class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="kt-form__group--inline">
                                                    ...
                                                    <div class="kt-form__control">
                                                        <input type="number" name="qty" class="form-control" placeholder="Min. Quantity">
                                                    </div>
                                                </div>
                                                <div class="d-md-none kt-margin-b-10"></div>
                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group kt-form__group">
                                ...
                                <input type="text" name="amount" autocomplete="off" id="product_amount" class="form-control" placeholder="Amount">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group kt-form__group">
                                ...
                                <textarea  class="form-control" name="description_l" id="product_description_l"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group kt-form__group">
                                ...
                                <div class="kt-form__control">
                                    <select class="form-control" id="product_offer_type" name="offer_type">
