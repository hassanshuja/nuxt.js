@include('backend.discount.product.add')
<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    <a href="javascript:void(0)" id="open-search-form" class="btn btn-default btn-icon-sm open-search-form">
                        <i class="la la-search"></i>
                        Search
                    </a>
                    <a href="javascript:void(0)" data-type="add" data-action="{!! route('admin.discount-product.add') !!}" data-toggle="modal" data-target="#add-product-discount" class="btn btn btn-success btn-icon-sm">
    ...
    <div class="kt-portlet__body">
        <!--begin: Search Form -->
        <form class="kt-form kt-form--fit kt-margin-b-20 search-table-form" data-modal="kt_table_3">
