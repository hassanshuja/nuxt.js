...
@include('backend.tag.css')
@section('content')
    @include('backend.tag.add')
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="javascript:void(0)" data-type="add" data-action="{!! route('admin.tag.add') !!}" data-toggle="modal" data-target="#add" class="btn btn btn-success btn-icon-sm">
